...
<head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <link rel="stylesheet" href="{{ asset('css/watch_girl.css') }}">
            ...
            <div class="hot-header" style="padding-bottom: 10px;">
                <div class="row hot-row">
                    <div class="col ">
                        ...
                        <button class="icon" style="background: none;border-radius: 10px;padding: 0px 50px 0px 50px;">Đồng hồ nữ</button>
                    </div>
                    <div class="col">
