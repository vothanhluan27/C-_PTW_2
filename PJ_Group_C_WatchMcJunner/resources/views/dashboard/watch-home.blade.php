...
<body>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="header-logo">
                            <a href="#" class="logo">
                                <img src="{{ asset('img/img-demo/logo.png') }}" alt="">
                            </a>
                        </div>
                    </div>
                    <!-- /LOGO -->
                                    ...
                                    <div class="cart-list">
                                        <div class="product-widget">
                                            <div class="product-img">
                                                <img src="{{ asset('img/img-demo/product01.png') }}" alt="">
                                            </div>
                                        ...
                                        <div class="product-widget">
                                            <div class="product-img">
                                                <img src="{{ asset('img/img-demo/product02.png') }}" alt="">
                                            </div>
                                            <div class="product-body">
                                                <h3 class="product-name"><a href="#">product name goes here</a></h3>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-xs-6">
                    <div class="shop">
                        <div class="shop-img">
                            <img src="{{ asset('img/img-demo/shop01.png') }}" alt="">
                        </div>
                        <div class="shop-body">
                ...
                <div class="col-md-4 col-xs-6">
                    <div class="shop">
                        <div class="shop-img">
                            <img src="{{ asset('img/img-demo/shop02.png') }}" alt="">
                        </div>
                        <div class="shop-body">
                        ...
                        <div class="products-tabs">
                            ...
                            <div id="tab1" class="tab-pane active">
                                <div class="products-slick" data-nav="#slick-nav-1">
                                    ...
                                    <div class="product">
                                        <div class="product-img">
                                            <img src="{{ asset('img/img-demo/product03.png') }}" alt="">
                                            <div class="product-label">
                                                <span class="sale">-30%</span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="product">
                                        <div class="product-img">
                                            <img src="{{ asset('img/img-demo/product04.png') }}" alt="">
                                        </div>
                                        <div class="product-body">
                                            <p class="product-category">Category</p>
                                            <h3 class="product-name"><a href="#">product name goes here</a></h3>
                                    ...
                                    <div class="product">
                                        <div class="product-img">
                                            <img src="{{ asset('img/img-demo/product05.png') }}" alt="">
                                        </div>
                                        <div class="product-body">
                                            <p class="product-category">Category</p>
                                            <h3 class="product-name"><a href="#">product name goes here</a></h3>
    ...
    <script src="{{ asset('js/home/nouislider.min.js') }}"></script>
    <script src="{{ asset('js/home/jquery.zoom.min.js') }}"></script>
